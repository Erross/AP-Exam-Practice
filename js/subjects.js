...
const AP_SUBJECTS = [
  ...
  },
  {
    ...
    category: "History & Social Sciences",
    tier: 1,
    // VERIFIED 2026-08-19 against the current AP World History: Modern CED,
    // AP Central exam page, and May 2027 history-exam update. Section I Part A
    // remains 55 MCQs / 55 minutes / 40%, primarily in 3–4 question source sets.
    mcqCount: 55,
    mcqTimeMinutes: 55,
    totalExamTimeLabel: "3h 15m",
    formatVerified: true,
