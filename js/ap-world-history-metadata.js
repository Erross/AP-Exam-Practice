// AP World History: Modern — development metadata bridge.
// Remove after consolidating this verified configuration into js/subjects.js for release.
(() => {
  "use strict";
  if (typeof AP_SUBJECTS === "undefined") throw new Error("AP subject registry must load before World metadata");
