...
(() => {
  ...
  const upgrades = {
    ...
    "2.22": {
      ...
      q3: ["Which source-analysis caution is most appropriate when using either narrative?", "A first-person narrative offers powerful evidence about an author's experience and argument, but it should be contextualized rather than treated as statistically representative of every enslaved woman.", ["Because personal experience introduces perspective, the narrative is most useful for studying the author's psychology rather than the institution of slavery.", "Because the author directly experienced slavery, audience and abolitionist purpose are less important than the factual details she reports.", "When similar themes appear in several narratives, a single narrative can be used to estimate how frequently those experiences occurred."], "First-person narratives are indispensable evidence, but their value comes from careful contextualization of authorship, purpose, audience, place, and experience—not from assuming one life represents an entire population.", "2.B"],
    },
  };
