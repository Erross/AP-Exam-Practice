...
(() => {
  ...
  const upgrades = {
    "2.17": {
      ...
      q1: ["Which interpretation is best supported by considering the Black Seminole sources together?", "Some African American freedom seekers built kinship and military alliances with Seminoles, while U.S. removal campaigns targeted those communities and their Black allies.", ["Black-Indigenous relations in the nineteenth-century South consisted only of conflict between Black and Indigenous people.", "Black Seminoles had no leadership roles and appear in the sources only as passive dependents.", "The Second Seminole War was unrelated to struggles over slavery, refuge, or removal."], "The sources make both Black agency and coercive removal visible. They support a history of alliance, refuge, leadership, and conflict with U.S. authorities, not a one-dimensional story of Black-Indigenous relations.", "2.A"],
