...
(() => {
  ...
  const sets = {
    ...
    "3.2": {
      ...
      q1: ["Which relationship appears most often in this synthetic sample?", "Seeking a child, with 24 notices.", ["Seeking a parent, with 18 notices.", "Seeking a spouse, with 15 notices.", "Seeking a sibling, with 21 notices."], "The 'Seeking child' row has the largest sample count at 24, exceeding sibling (21), parent (18), and spouse (15), so it is the most frequent relationship category in this constructed sample.", "2.D"],
